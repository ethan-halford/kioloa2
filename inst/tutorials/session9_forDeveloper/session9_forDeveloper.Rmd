...
<<<<<<< HEAD:inst/tutorials/session9_forDeveloper/sessionX_forDeveloper.Rmd
```{r,define_function_2}
=======
```{r,define_function_4}
>>>>>>> main:inst/tutorials/session9_forDeveloper/session9_forDeveloper.Rmd
...
<<<<<<< HEAD:inst/tutorials/session9_forDeveloper/sessionX_forDeveloper.Rmd
```{r badexample_4,exercise=T}
=======
```{r badexample_5,exercise=T}
>>>>>>> main:inst/tutorials/session9_forDeveloper/session9_forDeveloper.Rmd
