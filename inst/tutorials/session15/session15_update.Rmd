---
title: "Relatedness - an introduction in dartR"
...
*Session Presenters*
![Ethan Halford](images/Ethan.jpg){width=25%}
...
<<<<<<< HEAD:inst/tutorials/session15/session15.Rmd
## Using pedigrees
...
#### Simulation variables 
- Replace parents - whether parents reproduce more than once 
Influences number of offspring found within population - obviously has implications for relatedness ..... 
=======
>>>>>>> main:inst/tutorials/session15/session15_update.Rmd
...
![](images/IncaTern_2.jpg){width=50%}


You have spent the last 6 months on the windswept coast of Chile, studying the Inca tern.
You have been attempting to study the genetic underpinning for its famous mustache, which you understand to be an indicator of sexual fitness and general health! 

To understand the molecular underpinning for this trait and the method by which it is inherited you have collected samples from 75 individuals, in addition to constructing a pedigree by hand, from known crosses you have observed in the wild. Unfortunately, the pedigree has been lost when you spilt a full glass of yerba mate on your laptop! 
...
incaTernSNP <- readRDS("data/incaTernSNP.rds")
```
...
incaTernSNP <- gl.filter.allna(incaTernSNP)
incaTernSNP <- gl.filter.callrate(incaTernSNP,
                                  #The rest is up to you
)
incaTernSNP <- gl.filter.monomorphs(incaTernSNP)
incaTernSNP <- gl.filter.rdepth(incaTernSNP,
                                #The rest is up to you
                                )
incaTernSNP <- gl.filter.sexlinked(incaTernSNP,
                                   #The rest is up to you
)
...
```{r,PCOA,exercise=T,eval=FALSE}
# Start with basic PCOA plot
incaPCOA <- gl.pcoa(incaTernSNP,nfactors = "X")
incaPCOAPlot <- gl.pcoa.plot("PCOA",incaTernSNP)
...
```{r,hetCheck,exercise=T,eval=FALSE}
# Start with basic PCOA plot
gl.report.heterozygosity(incaTernSNP,method = "ind")
...
```{r,gl_diag_run,exercise=T,eval=FALSE}
# Start with basic PCOA plot
incaTernrelated <- gl.diagnostics.relatedness(incaTernSNP, 
                                              cleanup = "T/F", 
                                              which_tests = "wang",
                                              IncludePlots = "T/F",
                                              plotOut = "T/F",
...
Molecular Ecology Resources, 22(7), 2546-2558. https://doi.org/https://doi.org/10.1111/1755-0998.13630 
