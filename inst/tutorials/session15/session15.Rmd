...
- Chromosome_name - chromosome from which to extract allele frequencies 
Influences reference allele frequencies - determines reference allele frequency from which estimates of IBD are drawn. As such this choice has an out sized effect on estimates of relatedness. 
